...
export class Config {
    ...
    constructor() {
        ...
        this.url = 'https://zapata.co.tz/'; // Replace URL_PLACEHOLDER with you site url (http://example.com)
        this.consumerKey = 'ck_84559d94b50dddd8e29000ade7293250cfb22027'; //Replace CONSUMER_KEY_PLACEHOLDER with you site consumer_key
        this.consumerSecret = 'cs_11591f872403d9037c4f95fff90bd7171d036fc5'; //Replace CONSUMER_KEY_PLACEHOLDER with you site consumer_secret
